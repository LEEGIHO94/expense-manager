...
BEGIN
        ...
        WHILE outerVariable <= 10 DO
            INSERT INTO user(user_role, created_at, updated_at, email, password, service_subscriber)
            VALUES ('USER', NOW(), NOW(), CONCAT('test', outerVariable, '@gmail.com'), '{noop}password001!@#', 'RECOMMENDATION');
...
CALL create_budget('2023');
CALL create_expenditure('2023');
